...
public class SellETF {
    ...
    public static void render(String un, String PAN){
        ...
        System.out.print("Enter ticker of ETF to sell: ");
        ...
        try{
            ...
            String sql;
            sql = "select * from ETF where TKR = \'"+stock+"\';";
            ...
            while(rs.next()){
                ...
                double curval = rs.getDouble("Val");
            ...
            sql = "select * from Cust_ETF where TKR = \'"+stock+"\' and PAN = \'"+PAN+"\';";
            ...
            if (i==0){
                System.out.println("you do not own any shares of this ETF, quitting");
                return;
            }
            
            
            sql = "call sell_etf ("+num_shares+", "+sell_price+", \'"+stock+"\', \'"+PAN+"\');";
